...
import cloudAccountsRouter from "./routes/cloudAccounts/router.js";
import githubAccountsRouter from "./routes/githubAccounts/router.js";
...
app.use("/api/cloud-accounts", apiLimiter, cloudAccountsRouter);
app.use("/api/github-accounts", apiLimiter, githubAccountsRouter);
